<%-- 
    ...
    Created on : Apr 18, 2024, 5:19:38 PM
    Author     : 94753
--%>
...
<%@ page
	import="com.green_life.service.impl.*, com.green_life.service.*,com.green_lifet.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body style="background-color: #E6F9E6;">
	...
	if (user == null)
		user = new UserBean("Test User", 98765498765L, "test@gmail.com", "Ampara", 87659, "lksdjf");
	%>
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body text-center">
						<img src="images/profimg.png" class="rounded-circle img-fluid"
							style="width: 150px;">
						<h5 class="my-3">
							Hello
							<%=user.getName()%>
